                      ...
                      <div class="card z-depth-4">
                        <div class="card-content">
                          ...
                          <div class="row" style="margin-bottom: 0px !important;">
                            {!! Form::model($data['sucursal'], ['method' => 'POST', 'action' => ['SucursalController@store']]) !!}
                            <div class="input-field">
                                    {!! Form::token() !!}
                                  <div class="input-field col s12">
                                    <div class="input-field col s6 offset-s1">
                                        {!! Form::label('sucursal_name', 'Nombre Sucursal') !!}
                                        {!! Form::text('sucursal_name') !!}
                                    </div>
                                    <div class="input-field col s6 offset-s1">
                                        {!! Form::label('expired_on', 'Fecha de expiracion') !!}
                                        {!! Form::text('expired_on', '', ['class' => 'datepicker']) !!}
                                    </div>
                                </div>
                                <div class="input-field col s12">
                                    {!! Form::select('empresas[]', 
                                $data['empresas'],null,array('id' => 'Empresas Vigentes')) !!}
                                    {!! Form::label('empresas') !!}
